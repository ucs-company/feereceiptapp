  ...
  return (
    <div style={{ width: '1000px', fontFamily: "'Segoe UI', Arial, sans-serif", textAlign: 'left' }}>
      ...
      <div style={{ background: '#fff', border: `2px solid ${ACCENT}`, borderRadius: '10px', padding: '22px', marginBottom: '20px' }}>
        ...
        <div style={{ display: 'flex', borderBottom: `2px solid ${ACCENT}`, paddingBottom: '12px', marginBottom: '10px' }}>
          ...
          <div style={{ flex: 1, textAlign: 'center' }}>
            ...
            <div style={{ fontSize: '11px', color: '#000', lineHeight: '1.3' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginTop: '12px', border: `2px solid ${ACCENT}`, borderRadius: '6px', background: '#eaf8ff', padding: '10px 12px' }}>
          <div style={{ flex: 1, fontSize: '13px', color: '#333', fontWeight: 500 }}>
            Receipt No: <strong>{donor['Receipt No.']}</strong>
          </div>
          <div style={{ flex: 2, textAlign: 'center', fontWeight: 700, color: ACCENT, letterSpacing: '1px', fontSize: '16px' }}>
            80G CERTIFICATE OF DONATION
          </div>
          <div style={{ flex: 1, fontSize: '13px', color: '#333', fontWeight: 500, textAlign: 'right' }}>
        ...
        <div style={{ marginTop: '18px', fontSize: '14px', lineHeight: '1.7', color: '#222', textAlign: 'left' }}>
          ...
          <p>
            ...
            <span style={{ fontWeight: 700, marginLeft: '8px', marginRight: '8px', color: '#0a3d62' }}>
          ...
          <p>
            Your financial support helps us continue our mission of helping needy families through food kits, medical aid, education & other activities.
          </p>
      ...
      <div style={{ background: '#fff', border: `2px solid ${ACCENT}`, borderRadius: '10px', padding: '22px' }}>
        ...
        {/* Receipt Fields - div based rows */}
        <div style={{ border: `2px solid ${ACCENT}` }}>
          {/* Row 1: Receipt No + Date */}
          <div style={{ display: 'flex' }}>
            <div style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700, background: '#f3fbff', width: '25%' }}>
              Receipt No:
            </div>
            <div style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 600, background: '#fff', width: '25%' }}>
              {donor['Receipt No.']}
            </div>
            <div style={{ border: `1px solid ${ACCENT}`, padding: '10px', fontSize: '13px', fontWeight: 700, background: '#f3fbff', width: '25%' }}>
              Dated:
